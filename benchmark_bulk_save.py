...
def benchmark_bulk_save(deals, run_id):
    db = SessionLocal()
    start = time.time()
    db.bulk_save_objects([Deal(
        run_id=run_id,
        store_name=d['store_name'],
        item_name=d['item_name'],
        description=d.get('size', ''),
